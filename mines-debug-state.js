...
module.exports = async (req, res) => {
  ...
  try {
    // Hardcoded localhost URL for the mines server
    const upstreamUrl = 'http://localhost:8080';
    ...
    res.status(502).json({ 
      ...
      details: 'Cannot connect to localhost:8080 from Vercel. Make sure the mines server is running locally.'
    });
  }
};
